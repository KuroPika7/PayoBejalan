...
public class MainActivity extends AppCompatActivity {
    ...
    private ArrayList<String> arrId, arrName, arrAlamat, arrJam;
    ...
    private void SQLiteToArrayList(){
        ...
        if(varCursor.getCount() == 0){
            ...
            while (varCursor.moveToNext()){
                ...
                arrName.add(varCursor.getString(1));
    ...
    private void tampilDestinasi(){
        ...
        adDestinasi = new AdapterDestinasi(MainActivity.this, arrName, arrAlamat, arrJam);
